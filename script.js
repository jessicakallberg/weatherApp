...
modalBtn.addEventListener("click", function () {
    ...
    var geocodingUrl =
        ...
        cityName.value +
        "&appid=8baba0c5db732f6f778b4b45398cc49c";
    fetch(geocodingUrl)
        ...
        if (response.ok) {
            ...
            console.log(lon);
            var oneCallUrl =
                "https://api.openweathermap.org/data/2.5/onecall?lat="+lat+"&lon="+lon+"&units=imperial&appid=8baba0c5db732f6f778b4b45398cc49c";
            fetch(oneCallUrl)
                .then(function(response){
                if(response.ok) {
                    console.log(response);
            ...
            .catch(function(error){
                ...
                modalText2.textContent = "to weather";
                mainContent.classList.add("hidden");
            })
        });
    } else {
